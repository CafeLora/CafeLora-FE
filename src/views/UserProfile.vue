    ...
    <section id="right-side">
      ...
      <div class="flex-items">
        ...
        <div
          class="info-field"
          v-if="
            userInfoJson?.rol == 'Agricultoress'
          "
        >
          <p>Especialidad</p>
  ...
  methods: {
    ...
    calculateRolDisplay() {
      switch (this.$route.name) {
        ...
        case urlConstants.PROFILE_AGRICULTOR:
          this.titleProfile = "REGISTRAR AGRICULTOR";
          this.userInfoJson.rol = rol.AGRICULTOR;
          break;
    ...
    (async () => {
      ...
      if (this.$route.params.id) {
        try {
          ...
          userInfo.rol == rol.AGRICULTOR &&
            (this.titleProfile = "AGRICULTOR " + userInfo.codigo);
